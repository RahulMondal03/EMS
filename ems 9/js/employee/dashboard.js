    ...
    return `
      <tr>
        ...
        <td style="white-space:nowrap;">
          <a class="btn btn-ghost btn-sm" href="complaintDetails.html?id=${encodeURIComponent(k.id)}">View</a>
          ${k.status !== "Resolved"
            ? `<a class="btn btn-primary btn-sm" href="updateStatus.html?id=${encodeURIComponent(k.id)}">Update</a>` : ""}
        </td>
      </tr>`;
  }).join("") ||
